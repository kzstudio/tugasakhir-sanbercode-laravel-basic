...
<form action="/pertanyaan/{{$pertanyaan ->id}}" method="POST">
    ...
    <input type="text" class="form-control required" name="judul" value="{{$pertanyaan ->judul}}" placeholder="Masukan judul">
    </div>
    <div class="form-group">
      <label for="content">Pertanyaan</label>
    <textarea class="form-control required" id="content" name="isi" value="{{$pertanyaan ->isi}}" placeholder="Isi"></textarea>
    </div>
    <div class="form-group">
